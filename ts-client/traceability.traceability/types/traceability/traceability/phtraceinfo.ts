...
function createBasePhtraceinfo(): Phtraceinfo {
  return { id: 0, dic: "", drugprof: "", pharmacy: "", termofvalidity: "", customers: "", state: "", manufacturer: "" };
}

export const Phtraceinfo = {
  encode(message: Phtraceinfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
    ...
    if (message.customers !== "") {
      writer.uint32(50).string(message.customers);
    }
    if (message.state !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Phtraceinfo {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePhtraceinfo();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.customers = reader.string();
          break;
        case 7:
  ...
  fromJSON(object: any): Phtraceinfo {
    return {
      ...
      customers: isSet(object.customers) ? String(object.customers) : "",
      state: isSet(object.state) ? String(object.state) : "",
      manufacturer: isSet(object.manufacturer) ? String(object.manufacturer) : "",
    };
  },

  toJSON(message: Phtraceinfo): unknown {
    const obj: any = {};
    ...
    message.customers !== undefined && (obj.customers = message.customers);
    message.state !== undefined && (obj.state = message.state);
    message.manufacturer !== undefined && (obj.manufacturer = message.manufacturer);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Phtraceinfo>, I>>(object: I): Phtraceinfo {
    const message = createBasePhtraceinfo();
    ...
    message.customers = object.customers ?? "";
